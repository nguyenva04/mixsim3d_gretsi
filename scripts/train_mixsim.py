...
from drp.train.mixsim_training import MixSim3d
...
def main(
    ...
    train_dataset = Drp3dMMapDatasetSSL(config, train_flag="Train", transform=pair_transform, finetune=False)
    ...
    if config.distributed:
        ...
        trainer = MixSim3d(config=config)
